        ...
        <div className="w-full lg:w-1/2 bg-white shadow-xl p-10 rounded-lg border border-gray-300">
          ...
          <form className="space-y-6" onSubmit={handleFormSubmit}>
            ...
            <div className="form-control mt-6">
              <button 
                type="submit"
                className="btn btn-primary w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 rounded-md transition duration-200 shadow-lg hover:shadow-xl"
              >
                Login
              </button>
            </div>
